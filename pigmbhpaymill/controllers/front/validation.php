...
class PigmbhpaymillValidationModuleFrontController extends ModuleFrontController implements Services_Paymill_LoggingInterface
{
    ...
    public function initContent()
    {
        ...
        if ($result === true) {
            ...
            $this->saveUserData(
                $this->payment_processor->getClientId(), 
                $this->payment_processor->getPaymentId(), 
            ...
            $order_id = $this->module->validateOrder(
                (int) $this->context->cart->id, Configuration::get('PIGMBH_PAYMILL_ORDERSTATE'), 
    ...
    private function processPayment()
    {
        $this->payment_processor = new Services_Paymill_PaymentProcessor(
            Configuration::get('PIGMBH_PAYMILL_PRIVATEKEY'), 
        ...
        $this->payment_processor->setCurrency(strtolower($this->iso_currency));
