...
<form role="form" id='paymill_form' action="{$link->getModuleLink('pigmbhpaymill', 'validation', [], true)|escape:'html':'UTF-8'}" method="post" class="row">
    <div class="debit col-md-8 col-md-push-2">
        ...
        <div class="row">
            <div class="col-md-4 cart_navigation paymill_cart_navi">
                {if $opc}
                    <a href="{$link->getPageLink('order', true)|escape:'html':'UTF-8'}" autocomplete="off" class="button_large">{l s='Payment selection' mod='pigmbhpaymill'}</a>
                {/if}
                {if !$opc}
                    <a href="{$link->getPageLink('order', true)|escape:'html':'UTF-8'}?step=3" autocomplete="off" class="btn btn-default button-exclusive btn-lg"><i class="icon-chevron-left"></i> {l s='Payment selection' mod='pigmbhpaymill'}</a>
                {/if}
            </div>
